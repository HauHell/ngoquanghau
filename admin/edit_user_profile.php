                                ...
                                <div class="col-lg-9">
                                     <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name" 
                                            value="<?php echo $row_user['v_fullname'] ?>" class="form-control" placeholder="Enter Full Name">
                                        </div>
                                       ...
                                       <input type="hidden" name="user_id" value="<?php echo $row_user['n_user_id'] ?>">
                                        <button type="submit"  name="edit_user_profile" class="btn btn-default">Update Profile</button>
