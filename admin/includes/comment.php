...
class comment{
	...
	/*	$this->v_blog_post_title = htmlspecialchars(strip_tags($this->v_blog_post_title));
		...
		//Bind data
		$stmt->bindParam(':n_blog_comment_parent_id',$this->n_blog_comment_parent_id);
	...
	public function update(){
		...
		$stmt = $this->conn->prepare($query);
		//Clean data
		$this->n_blog_comment_parent_id = htmlspecialchars(strip_tags($this->n_blog_comment_parent_id));
